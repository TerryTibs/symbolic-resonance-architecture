#!/usr/bin/env python3
"""
SRA: SELF-SUPERVISED NEURO-SYMBOLIC AGENT (FINAL & VERIFIED)
============================================================
Features:
...
Fixes included:
- Added missing 'min_cluster_size' to CONFIG
- Applied .detach() to PPO logprobs to prevent graph errors
"""
...
CONFIG = {
    ...
    'min_cluster_size': 10  # <--- FIXED: Added missing key
}
...
def main():
    ...
    if len(memory) > 50:
        ...
        # FIXED: Accessing 'min_cluster_size' is now safe
        if hdbscan:
